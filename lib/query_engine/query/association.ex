defmodule QueryEngine.Query.Association do
  ...
  ## Example:
      ...
      iex> %QueryEngine.Query.Association{path: "company.employees"} |> QueryEngine.Query.Association.name
      :employees
  ...
  ## Example:
      ...
      iex> QueryEngine.Query.Association.from_path("company.employees")
      [
        %QueryEngine.Query.Association{
          binding: nil,
          parent_binding: nil,
          path: "company"
        },
  ...
  ## Example:
      ...
      iex> QueryEngine.Query.Association.from_side_loads(["organization", "organization.country"])
